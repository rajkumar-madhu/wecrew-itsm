...
function StatsCard({
  ...
  return (
    <div className={clsx('glass-card p-4 transition-all duration-300 hover:border-[color:var(--argus-signal)]/25', s.border)}>
            ...
            <div className="flex items-start gap-6 mb-5">
              ...
              <div className="flex-1 min-w-0">
                ...
                {cluster.aiAnalysis && cluster.aiAnalysis !== 'AI analysis unavailable' && (
                  <div className="p-3 rounded-lg bg-[color:var(--argus-signal-dim)] border border-[color:var(--argus-signal)]/25">
         ...
         serverError || !servers ? <AgentErrorState label="Server metrics unavailable" /> : (
          <div className="p-5">
            ...
            {servers.aiAnalysis && servers.aiAnalysis !== 'AI analysis unavailable' && (
              <div className="p-3 rounded-lg bg-[color:var(--argus-signal-dim)] border border-[color:var(--argus-signal)]/25 mb-3">
                <p className="text-[10px] font-semibold text-signal uppercase tracking-wider mb-1 flex items-center gap-1">
                  <Brain className="w-3 h-3" /> AI Analysis
                </p>
      ...
      <div className="glass-card overflow-hidden border-stone-200">
        ...
        <div className="p-5">
          ...
          {db.aiAnalysis && db.aiAnalysis !== 'AI analysis unavailable' && (
            <div className="p-3 rounded-lg bg-[color:var(--argus-signal-dim)] border border-[color:var(--argus-signal)]/25 mb-4">
              <p className="text-[10px] font-semibold text-signal uppercase tracking-wider mb-1 flex items-center gap-1">
                <Brain className="w-3 h-3" /> AI Analysis
              </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {db.tables.slice(0, 12).map((t: any) => (
                  <tr key={t.table_name} className="border-b border-stone-100 hover:bg-[color:var(--argus-signal-dim)]/50 transition-colors">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="glass-card p-4 border-stone-200">
          <div className="flex items-center gap-2 mb-1">
            <div className="p-1.5 rounded-lg bg-[color:var(--argus-signal-dim)]"><FileText className="w-3.5 h-3.5 text-signal" /></div>
      ...
      {logs.aiAnalysis && logs.aiAnalysis !== 'AI analysis unavailable' && (
        <div className="glass-card p-5 border-[color:var(--argus-signal)]/25 bg-[color:var(--argus-signal-dim)]/30">
              ...
              <div key={i} className="px-5 py-3">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className={clsx(
                    ...
                    issue.source === 'cluster' ? 'bg-[color:var(--argus-signal-dim)] text-signal' :
  ...
  return (
    <Page>
      ...
      {/* ══════════════════════════════════════════════════════
          ...
          ══════════════════════════════════════════════════════ */}
      <div className="glass-card overflow-hidden border-[color:var(--argus-signal)]/25">
            ...
            <button
              ...
              className={clsx(
                ...
                agentTab === key
                  ...
                  : 'border-transparent text-stone-400 hover:text-stone-600 hover:bg-[color:var(--argus-elevated)]'
              )}
            >
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {classifications.map((item: any) => (
                      <tr
                        key={item.id}
                        className="border-b border-stone-100 hover:bg-[color:var(--argus-signal-dim)]/50 transition-colors"
                      >
            ...
            {suggestionsLoading ? (
              ...
              <div className="divide-y divide-stone-100">
                {suggestions.map((item: any) => (
                  <div
                    key={item.id}
                    className="px-5 py-4 hover:bg-[color:var(--argus-signal-dim)]/30 transition-colors"
                  >
            ...
            >
              {msg.role === 'assistant' && (
                <div className="flex-shrink-0 mt-1">
                  <div className="w-7 h-7 rounded-lg bg-[color:var(--argus-signal-dim)] border border-[color:var(--argus-signal)]/25 flex items-center justify-center">
              ...
              >
                <p className={clsx(
                  ...
                  msg.role === 'user' ? 'text-ink' : 'text-stone-700'
                )}>
                  {msg.text}
                </p>
                <p className={clsx(
