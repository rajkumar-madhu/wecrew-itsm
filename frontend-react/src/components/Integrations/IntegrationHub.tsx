        ...
        <div className="relative px-6 py-5">
          <div className="flex items-start justify-between">
            <div>
              <div className="flex items-center gap-2.5 mb-1.5">
                ...
                <h1 className="font-display text-2xl font-bold text-white tracking-tight">Integration Hub</h1>
                <span className="text-[9px] font-mono font-bold text-indigo-300 bg-indigo-500/15 px-1.5 py-0.5 rounded border border-indigo-400/20">{integrations.length} TOOLS</span>
              </div>
              <p className="text-[#94A3B8] text-sm ml-[42px]">Connect, configure, and manage all external services and platforms</p>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/[0.06] border border-white/[0.08]">
                <div className="w-2 h-2 rounded-full bg-[#10B981] animate-pulse" />
                <span className="text-xs font-medium text-[#94A3B8]"><span className="text-white font-bold">{activeCount}</span> Active</span>
              </div>
            </div>
          </div>
          {/* ── Summary pills ── */}
          <div className="flex items-center gap-2 mt-3 ml-[42px]">
            {[
              ...
              <div key={p.label} className="flex items-center gap-1.5 px-2 py-1 rounded bg-white/[0.04] border border-white/[0.06]">
                <span className="text-[10px] text-[#64748B]">{p.label}</span>
                <span className="text-[10px] font-bold text-white">{p.active}/{p.count}</span>
              </div>
            ))}
          </div>
        </div>
            ...
            >
              {hasDashboard && integration.connected && (
                <div className="absolute top-3 right-3">
                  <span className="text-[9px] font-bold font-mono px-1.5 py-0.5 rounded bg-indigo-50 text-signal border border-indigo-200 flex items-center gap-1">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-stone-100">
                ...
                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  {hasDashboard && integration.connected && (
                    <button
                      className="p-1 rounded hover:bg-indigo-50 text-stone-400 hover:text-signal transition-colors"
                          ...
                          <button
                            ...
                            className={clsx(
                              ...
                              (formConfig.accessMethod || 'ssh') === opt.value
                                ? 'border-signal bg-indigo-50 text-signal'
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <button
                    ...
                    className={clsx(
                      ...
                      formEnabled ? 'bg-indigo-500' : 'bg-stone-300'
                    )}
                  >
                    <div className={clsx(
