          ...
          <div className="flex items-start justify-between">
            <div>
              <div className="flex items-center gap-2.5 mb-1.5">
                ...
                <h1 className="font-display text-2xl font-bold text-white tracking-tight">Assets / CMDB</h1>
                ...
                <span className="text-[10px] font-mono text-indigo-400 bg-indigo-500/10 px-2 py-0.5 rounded border border-indigo-500/20">{assets.length} shown</span>
              </div>
              <div className="flex items-center gap-2 text-sm ml-[42px]">
                ...
                <a href={window.location.origin} target="_blank" rel="noopener noreferrer" className="font-mono text-xs text-indigo-400 hover:text-indigo-300 transition-colors">
                  {window.location.host}
                </a>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <button onClick={() => navigate('/assets/create')} className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl text-sm font-semibold shadow-lg hover:shadow-emerald-500/25 transition-all duration-200 hover:scale-[1.02]">
                <Server size={15} /> New Asset
              </button>
              <div className="flex items-center gap-0.5 p-0.5 rounded-lg bg-white/[0.06] border border-white/[0.08]">
                <button onClick={() => setViewMode('grid')} className={clsx('p-2 rounded-md transition-all duration-200', viewMode === 'grid' ? 'bg-emerald-500 text-white shadow-sm' : 'text-slate-400 hover:text-white')} title="Grid view">
                  <Grid3X3 className="w-4 h-4" />
                </button>
                <button onClick={() => setViewMode('list')} className={clsx('p-2 rounded-md transition-all duration-200', viewMode === 'list' ? 'bg-emerald-500 text-white shadow-sm' : 'text-slate-400 hover:text-white')} title="List view">
